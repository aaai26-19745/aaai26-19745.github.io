...
def update_single_story_with_ref_images(
    ...
    Args:
        ...
        dataset_name: The name of the dataset (e.g., 'vistoryBench').
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", default="vistoryBench", help="Name of the dataset folder (e.g., vistoryBench)")
